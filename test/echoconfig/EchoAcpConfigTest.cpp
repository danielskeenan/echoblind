...
{
    const decltype(Preset::levels) levels100 = genLevelsMap(255, 1, 48);
    const decltype(Preset::levels) levels75 = genLevelsMap(192, 1, 48);
    const decltype(Preset::levels) levels50 = genLevelsMap(128, 1, 48);
    const decltype(Preset::levels) levels25 = genLevelsMap(64, 1, 48);
