...
TEST_CASE("Echo PCP Config")
{
    ...
    SECTION("Parse Cfg")
    {
        ...
        // Circuits.
        static const std::vector<Circuit> expectedCircuits = {
        ...
        // Presets.
        static const decltype(Preset::levels) levels100 = genLevelsMap(255);
        static const decltype(Preset::levels) levels75 = genLevelsMap(192);
        static const decltype(Preset::levels) levels50 = genLevelsMap(128);
        static const decltype(Preset::levels) levels25 = genLevelsMap(64);
        static const decltype(Preset::fadeTimes) times0 = {{1, 0}, {2, 0}};
        static const std::vector<Preset> expectedPresets = {
